...
public class DataBarangSoldOutActivity extends AppCompatActivity {

    private static final String TAG = "DataBarangSoldOutActivi";
    @BindView(R.id.recycler_view_data_barang_container)
    RecyclerView recyclerViewDataBarangSoldOut;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Data Barang Sold Out");
    ...
    private void getDataBarang() {
        apiInterface.dataBarangSoldOut().enqueue(new Callback<DataBarangResponse>() {
            @Override
            public void onResponse(Call<DataBarangResponse> call, Response<DataBarangResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body().getStatus()) {
                        ...
                        recyclerViewDataBarangSoldOut.setAdapter(dataBarangRViewAdapter);
                        recyclerViewDataBarangSoldOut.setLayoutManager(new LinearLayoutManager(getApplicationContext()));
